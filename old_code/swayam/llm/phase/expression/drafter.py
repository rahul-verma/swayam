...
class Drafter:
    ...
    def __init__(self, *, entity, thought, aggregate_name, interim=False, blueprint_name=None, mode="overwrite", force_unique_entries=False, refer=None, feed=None, reset_conversation=True):
        ...
        self.__force_unique_entries=force_unique_entries
        ...
        with open(self.__file_path, "w") as file:
            if isinstance(content, dict):
                if content[self.__entity.primary_key] not in updated_content:
                    ...
                    if self.__force_unique_entries:
                        updated_content[content[self.__entity.primary_key] + "-" + str(uuid.uuid4())] = [content[self.__entity.content_key]]
                    else:
