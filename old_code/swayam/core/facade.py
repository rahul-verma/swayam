...
class _SwayamSingleton:
    ...
    def __register_config_with_tarkash(self, folio_dir):
        ...
        reg_config = {
            ...
            "DEFINITION_ENTITY_DIR": ("definition/entity", "project_relative_path"),
            "FOLIO_DIR": (folio_dir, "absolute_path"),
            "FOLIO_NARRATION_DIR": (os.path.join(folio_dir, "narration"), "absolute_path"),
            "FOLIO_AGGREGATE_DIR": (os.path.join(folio_dir, "aggregate"), "absolute_path"),
            "FOLIO_OUTPUT_DIR": (os.path.join(folio_dir, "output"), 
                                      "absolute_path"),
            "FOLIO_BLUEPRINT_DIR": (os.path.join(folio_dir, "blueprint"), 
                                      "absolute_path"),
