...
NumericValue = Template.build("NumericValue", model=NumericValueModel)
Counter = Template.build("Counter", model=CounterModel)
NumericValues = Template.build("NumericValues", model=NumericValuesModel)
StringValue = Template.build("StringValue", model=StringValueModel)
StringValues = Template.build("StringValues", model=StringValuesModel)
BoolValue = Template.build("BoolValue", model=BoolValueModel)
BoolValues = Template.build("BoolValues", model=BoolValuesModel)
NoneValue = Template.build("NoneValue", model=NoneValueModel)