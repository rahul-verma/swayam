...
Result = Template.build("Result", model=ResultModel)    
Success = Template.build("Success", model=SuccessModel)
Failure = Template.build("Failure", model=FailureModel)
Error = Template.build("Error", model=ErrorModel)