...
class FilesInfoModel(BaseModel):
    files: List[FileInfoModel] = Field(..., description="List of FileInfoModel objects")
    
FileInfo = Template.build("FileInfo", model=FileInfoModel) 
FilesInfo = Template.build("FilesInfo", model=FilesInfoModel)