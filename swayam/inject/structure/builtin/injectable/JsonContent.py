...
# SerializedJson = Structure.build("SerializedJson", model=SerializedJsonModel)
# SerializedJsonList= Structure.build("SerializedJsonList", model=SerializedJsonListModel)

JsonContent = Structure.build("JsonContent", model=JsonContentModel)