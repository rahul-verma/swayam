...
from .TextContent import TextContentModel

class CodeBlockParserModel(TextContentModel):
...
CodeBlockParser = Structure.build("CodeBlockParser", model=CodeBlockParserModel)