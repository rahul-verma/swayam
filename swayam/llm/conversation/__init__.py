...
class Conversation:
    ...
    def has_system_prompt(self):
        return self._get_first_child().system_prompt
        
    def set_system_prompt(self, prompt:SystemPrompt):
        self._get_first_child().set_system_prompt(prompt)
    ...
    @classmethod
    def from_text(cls, text, *, system_prompt:str=None, image:str=None):
        if system_prompt:
            system_prompt = SystemPrompt(text=system_prompt)
        return Conversation(UserPrompt(text=text, system_prompt=system_prompt))
