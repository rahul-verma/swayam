...
class StructuredParser:
    ...
    def __init__(self, name, *, callable, input_structure, content_structure, output_structure):
        self.__name = name
    ...
    def __call__(self, content, **kwargs):
        ...
        # Trigger any pre-processing before call is made to the callable
...
class TextContentParser(StructuredParser):
    ...
    def __init__(self, name, *, callable, input_structure=None, output_structure=None):
        from swayam.inject.structure.builtin import TextContent
        if input_structure is None:
            input_structure = TextContent
        super().__init__(name, callable=callable, input_structure=input_structure, output_structure=output_structure, content_structure=None)

class JsonContentParser(StructuredParser):
    
    def __init__(self, name, *, callable, content_structure=None, output_structure=None, input_structure=None):
        from swayam.inject.structure.builtin import JsonContent, JsonContentList
        if input_structure is None:
